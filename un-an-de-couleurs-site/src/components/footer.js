            ...
            <div className={footerStyles.container}>
                <div className={footerStyles.summary}>
                    <div className={footerStyles.divcontainer}>
                        <p className={footerStyles.footertext}>Un an de couleurs est un projet artistique de Olivier Keutgens, Organik de mon nom d’artiste.<br/>
                ...
                <div className={footerStyles.contact}>
                    <div className={footerStyles.divcontainer}>
                        ...
                        <p className={footerStyles.footertext}>organik.artist@gmail.com</p>
                    </div>
                </div>
            </div>
            <div className={footerStyles.divcontainer}>
