        ...
        <Layout>
            <div className={proposStyles.container}>
                ...
                <section className={proposStyles.sos}>
                    ...
                    <div className="paragraph-container">
                        <h3 className="h2-title font-color-cycle">Tu désires m’aider?</h3>
                        <p className="text-normal">J’ai besoin de supports (objets, tableaux, panneaux, etc.), peintures, de cadres et pinceaux en tout genre pour faire des oeuvres. Toute donation est accueillie avec ma plus sincère reconnaissance et mon plus chaleureux sourire, d’autant plus si cela permet de recycler un objet inutilisé.</p>
                    </div>
                    <div className="paragraph-container">
                        <h3 className="h2-title font-color-cycle">Tu souhaites m’avoir en peinture?</h3>
                    ...
                    <div className="paragraph-container">
                        <h3 className="h2-title font-color-cycle">Tu veux m’inspirer?</h3>
                    ...
                    <div className="paragraph-container">
                        ...
                        <p className="text-normal">Un petit message de soutien, une bonne intention ou même une lettre d’amour ça fait toujours plaisir à recevoir et c’est ce qui donne vraiment des ailes (contrairement à boisson). Ouvrir nos coeurs c’est la clé pour un monde meilleur!</p>
                    </div>
                </section>
