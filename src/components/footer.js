            ...
            <div className={footerStyles.container}>
                <div className={footerStyles.summary}>
                    <div className={footerStyles.divcontainer}>
                        ...
                        Le concept est de partager des oeuvres artistiques quotidiennement pendant un an. La plupart des oeuvres sont disponibles à la vente à prix libres, en plus de la possibilité de faire une commande personnelle.</p>
                    </div>
                </div>
