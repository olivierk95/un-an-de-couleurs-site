                        ...
                        <div className="content-container">
                            ...
                            <div className="paragraph-container">
                                ...
                                <p className="text-normal">Passionné de créations et de dessins depuis mon plus jeune âge, l’art urbain est très vite devenu une sorte de fantasme dans ma vie. Dès 13-14 ans, je choisis le blaze “OrganiK”, collectionne les livres de street art/graffiti et je réalise même mon TFE secondaire sur le sujet. 
                                    <br/><br/>
                                    Pourtant, c'est dans des études en sciences économiques à HEC-ULg que je me lance après la secondaire. J’y réalise un bachelier en sciences économiques et de gestion et un master en marketing à HEC-ULg. Peu enthousiaste à la suite de mes études, j'entreprends une formation d’un an en développement web avec l’organisme Becode. Bien que très enrichissante (surtout dans le domaine de l’auto-apprentissage), je sens que passer mes journées sur un écran n’est pas fait pour moi, je décide alors de réaliser un rêve; partir plus d’un an à l’aventure en amérique centrale pour y développer des projets de manière bénévole. Lors de mon aventure, j’en profite pour me rapprocher un peu plus de cette passion laissée au placard durant mes années d’études. Quelques fresques murales, des réalisations de t-shirts, un projet artistique super chouette avec des enfants dans une école du Guatemala, sont autant de réalisations qui restent de très bons souvenirs. Une expérience qui m’a beaucoup apporté sur le plan professionnel mais surtout sur le plan humain et que j’aurai adoré poursuivre. Mais le covid est passé par là et a tout chamboulé: retour en Belgique prématuré sans projet concret…
                                    <br/><br/>
                                    C'est alors que germe le projet "Un An de Couleurs" dans ma tête. Un peu comme un petit challenge personnel, je réalise presque quotidiennement des œuvres avec beaucoup de passion et avec pour objectif d’affiner mon style et ma technique durant un an (avec l’espoir caché d’en vivre partiellement).</p>
                            </div>
                            <div className="paragraph-container">
                                <h4 className="h3-title">Ma démarche artistique</h4>
                                <p className="text-normal">Je représente la vie, les humains, la nature, les animaux, toute sorte d’être vivant en plus ou moins gros plan. Je suis un amoureux du vivant dans son ensemble. J’adore observer la nature et m’y balader. Elle éveille en moi toute la fascination, la curiosité et l’innocence d’un enfant.<br/>
                                    J’abuse des couleurs dans le but d’apporter un peu de chaleur et de richesse à mes œuvres. J’espère apporter un sentiment de gaieté, d’amour et d’humanité aux gens qui y passent leur regard.<br/>
                ...
                <section className={proposStyles.sos}>
                    <div className={proposStyles.sectioncontainer}>
                        ...
                        <div className="content-container">
                            ...
                            <p className="text-normal">Un petit message de soutien, une bonne intention ou même une lettre d’amour ça fait toujours plaisir à recevoir et c’est ce qui donne vraiment des ailes (contrairement à la célèbre boisson). Ouvrir nos coeurs c’est la clé pour un monde meilleur! (c'est beau ça)</p>
                        </div>
                    </div>
                </section>
